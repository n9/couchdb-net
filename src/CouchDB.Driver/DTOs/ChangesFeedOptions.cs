...
namespace CouchDB.Driver.DTOs
{
    ...
    public class ChangesFeedOptions
    {
        ...
        internal IEnumerable<(string Name, string Value)> ToQueryParameters()
        {
            ...
            {
                var propertyName = GetAttribute<JsonPropertyAttribute>(propertyInfo)?.PropertyName;
                object propertyValue = propertyInfo.GetValue(this);
                object propertyDefaultValue = GetAttribute<DefaultValueAttribute>(propertyInfo)?.Value;
